...
abstract class CustomerPtLang {
  static const words = <String, String>{
    CustomerKeysLang.errorGetCustomers: 'Erro ao buscar clientes',
    CustomerKeysLang.noCustomersFound: 'Nenhum cliente encontrado',
    CustomerKeysLang.newCustomer: 'Novo Cliente',
    CustomerKeysLang.editCustomer: 'Editar Cliente',

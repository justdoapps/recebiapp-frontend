...
abstract class HomeUsLang {
  static const words = <String, String>{
    ...
    HomeKeysLang.noNotesProvided: 'No notes provided',
    HomeKeysLang.noPaymentInfoProvided: 'No payment info provided',
    HomeKeysLang.notPaidYet: 'Not paid yet',
    HomeKeysLang.notes: 'Notes',
    HomeKeysLang.dates: 'Dates',
    HomeKeysLang.basicInfo: 'Basic info',
    HomeKeysLang.attachments: 'Attachments',
    HomeKeysLang.message: 'Message',
    HomeKeysLang.couldNotOpenWhatsApp: 'Could not open WhatsApp',
